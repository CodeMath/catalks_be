...
from apps.chat_rooms.domain.use_cases.chat_room_use_cases import ChatRoomUseCase
from apps.chat_rooms.models import ChatRoomModel
from apps.chat_rooms.interface_adapters.gateways.orm_chat_room_repository import ORMChatRoomRepository
from apps.chat_rooms.serializers import ChatRoomModelSerializer
...
class ChatRoomViewSet(viewsets.ViewSet):
    ...
    @swagger_auto_schema(
        ...
        f'''채팅방 신규 생성''',
        request_body=ChatRoomModelSerializer, responses={201: ChatRoomModelSerializer})
